    ...
    <div className="p-2 gap-2 flex flex-col justify-center items-center w-full">
      ...
      <div className=" flex items-end justify-center gap-2 ">
        ...
        <button
          onClick={handleStart}
          disabled={isRunning}
          className="transition-all disabled:text-rose-50/80 text-rose-50/90 hover:text-rose-50 text-2xl w-10 group gap-2 disabled:bg-black/40 bg-black/50   h-10  rounded-full border-2 disabled:border-rose-500/20 border-rose-500/40 shadow-none shadow-rose-900/20 hover:shadow-lg hover:shadow-rose-900/40 duration-100 hover:border-rose-500/60  p-1 flex justify-center items-center active:border-rose-400 active:shadow-rose-400/50 active:text-white select-none cursor-pointer"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
